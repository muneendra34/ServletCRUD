...
/**
 * Servlet implementation class DotNetIndexEdit
 */
@WebServlet("/DotNetIndexEdit")
public class DotNetIndexEdit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<!DOCTYPE html>\r\n" + 
				...
				"<title>.Net Developer Update page</title>\r\n" + 
				"<link href=\"css/style.css\" rel=\"stylesheet\">\r\n" + 
				"</head>\r\n" + 
				"<body>\r\n" + 
				"<center>\r\n" + 
				"<form action=\"DotNetEditServlet\" method=\"post\" >\r\n" + 
				"  <div class=\"container\">\r\n" + 
				"    <h1>Update .Net Developer Details :</h1>\r\n" + 
				"    <hr>\r\n" + 
				"    <b>First Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b>\r\n" + 
				...
				"  	<b>Designation :&nbsp;&nbsp;&nbsp;&nbsp;</b>\r\n" + 
				"  	<input type=\"text\" name=\"desig\" value=\"DotNet_Developer\"><br>\r\n" + 
				"    <input type=\"submit\" class=\"registerbtn\" value=\"Edit Details\"></form>\r\n" + 
				"    <br>\r\n" + 
				"  	<a href=\"dotnetlogin.html\">Click here  </a> for Login form.</form>  </div>\r\n" + 
				"<center>\r\n" + 
				"</body>\r\n" + 
				"</html>");
