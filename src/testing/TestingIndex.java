...
/**
 * Servlet implementation class TestingIndex
 */
@WebServlet("/TestingIndex")
public class TestingIndex extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean b = ck.goTestingLoginCheck(fn,psw);
		if( b == true)
		{
			...
			out.println("<!DOCTYPE html>\r\n" + 
					...
					"<form action=\"TestingIndexEdit\" method=post><input type=\"submit\" class=\"btn btn-info\" value=\"Update\"></form>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+
					"<form action=\"TestingIndexDelete\" method=post onsubmit=\"return confirm('Do you really want to delete the user?');\"><input type=\"submit\" class=\"btn btn-danger\" value=\"Delete\"></form>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+
					"<form action=\"TestingIndexLogout\" method=post><input type=\"submit\" class=\"btn btn-warning\" value=\"Logout\"></form></div></div>");
					out.println("</div>\r\n  </div>\r\n" + 
					"</div>\r\n" + 
					"\r\n");
					out.println("</body>\r\n" + 
		...
		{
			response.sendRedirect("testing/testingloginerror.html");
		}
