...
/**
 * Servlet implementation class NetworkIndex
 */
@WebServlet("/NetworkIndex")
public class NetworkIndex extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean b = ck.goNetworkLoginCheck(fn,psw);
		if( b == true)
		{
			NetworkActions na = new NetworkActions();
			ResultSet rs = null;
			rs = na.goGetDetails(fn);
			...
			out.println("<!DOCTYPE html>\r\n" + 
					...
					"<form action=\"NetworkIndexEdit\" method=post><input type=\"submit\" class=\"btn btn-info\" value=\"Update\"></form>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+
					"<form action=\"NetworkIndexDelete\" method=post onsubmit=\"return confirm('Do you really want to delete the user?');\"><input type=\"submit\" class=\"btn btn-danger\" value=\"Delete\"></form>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+
					"<form action=\"NetworkIndexLogout\" method=post><input type=\"submit\" class=\"btn btn-warning\" value=\"Logout\"></form></div></div>");
					out.println("</div>\r\n  </div>\r\n" + 
					"</div>\r\n" + 
					"\r\n");
					out.println("</body>\r\n" + 
		...
		{
			response.sendRedirect("network/networkloginerror.html");
		}
