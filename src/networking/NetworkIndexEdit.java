...
/**
 * Servlet implementation class NetworkIndexEdit
 */
@WebServlet("/NetworkIndexEdit")
public class NetworkIndexEdit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<!DOCTYPE html>\r\n" + 
				...
				"<title>Network Engineer Update page</title>\r\n" + 
				"<link href=\"css/style3.css\" rel=\"stylesheet\">\r\n" + 
				"</head>\r\n" + 
				"<body>\r\n" + 
				"<center>\r\n" + 
				"<form action=\"NetworkEditServlet\" method=\"post\" >\r\n" + 
				"  <div class=\"container\">\r\n" + 
				"    <h1>Update Network Engineer Details :</h1>\r\n" + 
				"    <hr>\r\n" + 
				"    <b>First Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b>\r\n" + 
				...
				"  	<b>Designation :&nbsp;&nbsp;&nbsp;&nbsp;</b>\r\n" + 
				"  	<input type=\"text\" name=\"desig\" value=\"Network_Engineer\"><br>\r\n" + 
				"    <input type=\"submit\" class=\"registerbtn\" value=\"Edit Details\"></form>\r\n" + 
				"    <br>\r\n" + 
				"  	<a href=\"networklogin.html\">Click here  </a> for Login form.</form>  </div>\r\n" + 
				"<center>\r\n" + 
				"</body>\r\n" + 
				"</html>");
